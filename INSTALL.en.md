...
Open the [**Releases**](https://github.com/wblekhoa/readease/releases/latest) page and download `ReadEase-<version>-arm64.dmg`. Double-click to open it — the window shows `ReadEase.app` beside an Applications folder; drag the app in. (A `.zip` is there too: double-click to unpack, then drag `ReadEase.app` into Applications.)
...
> A dialog saying the app **"is damaged and can't be opened"** means the download was altered after download (a browser or antivirus rewrote it). Delete it and download again from the official Releases page; do not reach for `xattr` or turn security off.
...
| "…is damaged and can't be opened" | The download was altered after download | Delete and download again |
