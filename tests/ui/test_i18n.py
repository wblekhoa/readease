"""The Qt shell's own localizer.

The three guards that were here and are NOT about Qt moved out first, because
they outlive this shell: translation coverage to
`tests/test_translation_coverage.py`, reading its table from the shell that
ships, and the document claims to `tests/test_documentation_claims.py`.
"""
