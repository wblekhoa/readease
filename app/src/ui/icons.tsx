 ...
 * waves are the source's, as in `SpeakerIcon`; the sparkle is a plain
 * four-point star, and the body is knocked out around it so the star
 * stands off the mass the way the frame shows. Whole body at the light
 * weight (the frame keeps the back of the speaker light too). */
export function AiSpeakerIcon({ className }: { className?: string }) {
  return (
    <svg {...bulk} className={className}>
      <path d="M18 16.75a.75.75 0 0 1-.6-1.2 5.94 5.94 0 0 0 0-7.1.75.75 0 0 1 1.2-.9c1.96 2.62 1.96 6.28 0 8.9-.15.2-.37.3-.6.3Z" />
      <path d="M19.828 19.25a.75.75 0 0 1-.6-1.2c2.67-3.56 2.67-8.54 0-12.1a.75.75 0 0 1 1.2-.9c3.07 4.09 3.07 9.81 0 13.9-.14.2-.37.3-.6.3Z" />
      <path opacity={MASS} fillRule="evenodd" d="M15.75 7.412v9.18c0 1.72-.62 3.01-1.73 3.63a3 3 0 0 1-1.47.37c-.8 0-1.66-.27-2.54-.82l-2.92-1.83c-.2-.12-.43-.19-.66-.19H5.5v-11.5h.93c.23 0 .46-.07.66-.19l2.92-1.83c1.46-.91 2.89-1.07 4.01-.45 1.11.62 1.73 1.91 1.73 3.63ZM5.5 6.25v11.5H5c-2.42 0-3.75-1.33-3.75-3.75v-4c0-2.42 1.33-3.75 3.75-3.75h.5ZM5.4 11.8L7.33 16.07L11.6 18L7.33 19.93L5.4 24.2L3.47 19.93L-0.8 18L3.47 16.07Z" />
      <path d="M5.4 13.4L6.83 16.57L10 18L6.83 19.43L5.4 22.6L3.97 19.43L0.8 18L3.97 16.57Z" />
    </svg>
  );
}
