...
// `languages: ["vi"]` on every one of them, exactly as the engine now
// publishes it: VieNeu is a Vietnamese model and the engine refuses to read
// anything else with it, so the harness must show the same truth the app does.
const VOICES = [
  { id: "Minh Đức", label: "Minh Đức — Nam · Bắc · Phong cách tin tức", languages: ["vi"] },
  { id: "Phạm Tuyên", label: "Phạm Tuyên — Nam · Bắc · Phong cách tự nhiên", languages: ["vi"] },
  { id: "Thái Sơn", label: "Thái Sơn — Nam · Nam · Phong cách kể chuyện", languages: ["vi"] },
  { id: "Xuân Vĩnh", label: "Xuân Vĩnh — Nam · Nam · Phong cách tự nhiên", languages: ["vi"] },
  { id: "Thanh Bình", label: "Thanh Bình — Nam · Bắc · Phong cách kể chuyện", languages: ["vi"] },
  { id: "Trúc Ly", label: "Trúc Ly — Nữ · Bắc · Phong cách tự nhiên", languages: ["vi"] },
  { id: "Ngọc Linh", label: "Ngọc Linh — Nữ · Bắc · Phong cách kể chuyện", languages: ["vi"] },
  { id: "Đoan Trang", label: "Đoan Trang — Nữ · Bắc · Phong cách tự nhiên", languages: ["vi"] },
  { id: "Mai Anh", label: "Mai Anh — Nữ · Bắc · Phong cách tin tức", languages: ["vi"] },
  { id: "Thục Đoan", label: "Thục Đoan — Nữ · Nam · Phong cách kể chuyện", languages: ["vi"] },
  { id: "Minh Triết", label: "Minh Triết — Nam · Nam · Phong cách tin tức", languages: ["vi"] },
  { id: "Thùy Dung", label: "Thùy Dung — Nữ · Nam · Phong cách tin tức", languages: ["vi"] },
  { id: "Quang Sơn", label: "Quang Sơn — Nam · Trung · Phong cách tự nhiên", languages: ["vi"] },
  { id: "Ngọc Trân", label: "Ngọc Trân — Nữ · Trung · Phong cách tự nhiên", languages: ["vi"] },
  { id: "Mỹ Duyên", label: "Mỹ Duyên — Nữ · Nam · Phong cách đọc truyện", languages: ["vi"] },
  { id: "Quỳnh Anh", label: "Quỳnh Anh — Nữ · Bắc · Phong cách đọc truyện", languages: ["vi"] },
  { id: "Đức Trí", label: "Đức Trí — Nam · Nam · Phong cách đọc truyện", languages: ["vi"] },
  { id: "Kim Thanh", label: "Kim Thanh — Nữ · Nam · Phong cách đọc truyện", languages: ["vi"] },
  { id: "Ngọc Huyền", label: "Ngọc Huyền — Nữ · Bắc · Giọng đọc tự nhiên", languages: ["vi"] },
