...
export const TEXT = {
  ...
  "reader.mode_pages": ["Đang lật trang · bấm để cuộn", "Pages · click for scroll"],
  "reader.mode_scroll": ["Đang cuộn · bấm để lật trang", "Scroll · click for pages"],
  ...
  "player.settings_open": ["Mở cài đặt giọng đọc", "Open voice settings"],
