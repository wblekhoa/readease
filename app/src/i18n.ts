...
export const TEXT = {
  ...
  "sidebar.resize": ["Kéo để đổi bề rộng cột bên · bấm đúp về mặc định", "Drag to resize the side column · double-click to reset"],
  "sidebar.current": ["Đang mở", "Current"],
  "sidebar.lists": ["Danh sách của tài liệu", "The document's lists"],
  ...
  "reader.open_failed": [
    ...
    "This document would not open. It is still in your library - the app just could not read it this time.",
  ],
  ...
  "reader.search": ["Tìm trong tài liệu", "Search in document"],
  ...
  "notes.empty": ["Tài liệu này chưa có highlight nào.", "Nothing marked in this document yet."],
  "notes.remove_failed": [
  ...
  /* Split out of `refused` on 10/09. That sentence blames the PASSAGE, and
     ...
     for what upset anybody. Two situations wore one sentence, and only one
     of them was theirs to act on. */
  "voiceerr.voice_gone": [
  ...
  "voices.sample": ["Tôi sẽ đọc tài liệu cho bạn nghe bằng giọng này.", "Tôi sẽ đọc tài liệu cho bạn nghe bằng giọng này."],
  "voices.sample_en": [
    "I will read your documents aloud in this voice.",
    "I will read your documents aloud in this voice.",
  ],
  "voices.filters": ["Lọc danh sách", "Filter the list"],
  "voices.language": [
    "Cuốn này đọc bằng",
    "This document is read in",
  ],
  ...
  "voices.language_suggested": [
    "{name}: nội dung tài liệu đọc ra thứ tiếng này",
    "{name} - the document's own text reads as this",
  ],
  "voices.filter_language": ["Giọng cho", "Made for"],
  ...
  "library.description": [
    "PDF phải có lớp văn bản - bản scan chưa đọc được.",
    "A PDF needs a text layer - a scanned copy cannot be read yet.",
  ],
  "library.imported": ["Đã thêm tài liệu vào thư viện.", "Document added to the library."],
  "library.duplicate": [
    "Tài liệu này đã có trong thư viện.",
    "This document is already in the library.",
  ],
  "library.importing": ["Đang nhập tài liệu…", "Importing…"],
  ...
  "library.drop_hint": ["Thả tệp để nhập tài liệu", "Drop the file to import it"],
  "library.drop_many": ["Thả để thêm {count} tài liệu vào thư viện", "Drop to add {count} documents to the library"],
  ...
  "library.drop_none_hint": ["Những tệp đang kéo không phải EPUB hay PDF.", "None of what is being dragged is an EPUB or a PDF."],
  ...
  "library.damaged": ["Dữ liệu tài liệu bị hỏng", "Document data is damaged"],
  ...
  "library.load_failed": [
    "Không mở được thư viện. Tài liệu trên máy KHÔNG bị xoá - ứng dụng chỉ chưa đọc được danh sách.",
    "Could not open the library. Nothing on this Mac was deleted - the app just could not read the list.",
  ],
  "library.from_apple_books": ["Từ Apple Books · còn cặp nối, đồng bộ ghi chú sẽ tìm đúng bản này", "From Apple Books - still paired, so a note sync finds this copy"],
  "library.apple_books": ["Từ Apple Books", "From Apple Books"],
  "apple.title": ["Tài liệu trong Apple Books", "Items in Apple Books"],
  "apple.one_way": [
    "Một chiều: chỉ đọc từ Apple Books, không ghi ngược lại.",
    "One way: read from Apple Books, never written back.",
  ],
  "apple.search": ["Tìm theo tên, hoặc gõ \"drm\", \"ghi chú\"…", "Search by title, or type \"drm\", \"highlights\"…"],
  "apple.no_match": ["Không có mục nào khớp.", "Nothing matches."],
  ...
  "apple.import_only": ["Chỉ nhập tài liệu", "Document only"],
  ...
  "apple.status_missing": ["Không thấy tệp", "File not found"],
  ...
  "apple.error.encrypted": ["Mục này có DRM, không sao chép được.", "This item is encrypted and cannot be copied."],
  "apple.error.too_large": ["Tệp này quá lớn để nhập.", "This file is too large to import."],
  "apple.error.book_missing": ["Không thấy tệp của mục này.", "This item's file could not be found."],
  "apple.error.not_in_library": ["Nhập tài liệu trước rồi mới đồng bộ ghi chú.", "Import the document first, then sync its highlights."],
  "external.steps": [
  ...
  "model.english_note": [
    "Tài liệu tiếng Anh đọc bằng giọng tiếng Anh trên máy. Tải một lần, không cần khoá API.",
    "English documents are read by the English voice on this Mac. Downloaded once, no API key needed.",
  ],
  "model.english_ready": ["Đã tải · {size}", "Downloaded · {size}"],
  "model.download": ["Tải về", "Download"],
  "model.download_use": ["Tải và dùng", "Download and use"],
  ...
  "transfer.title": [
    "Xem trước rồi chuyển ghi chú sang bản kia",
    "Preview your notes, then move them to the other copy",
  ],
  "transfer.description": [
    "Sao lưu trước khi ghi; không đụng bản nguồn.",
    "Backed up before writing; the source copy is untouched.",
  ],
  "transfer.pick_book": ["Chọn tài liệu…", "Choose a document…"],
  "transfer.source": ["Lấy ghi chú từ", "Take notes from"],
  "transfer.target": ["Chuyển sang", "Move them to"],
  "transfer.preview": ["Xem trước", "Preview"],
  "transfer.swap": ["Đảo hai bản", "Swap the two copies"],
  "transfer.change_books": ["Chọn tài liệu khác", "Choose different documents"],
  "transfer.pick_two": ["Chọn hai bản khác nhau để xem trước.", "Pick two different copies to preview."],
  ...
  "noteserr.ambiguous": [
    "Apple Books đang có nhiều mục trùng mã cho bản này, nên chưa chọn được chắc chắn. Hãy mở lại Apple Books rồi thử lại.",
  ...
  "noteserr.book_gone": [
    "Mục này không còn trong thư viện Apple Books. Mở lại mục này để làm mới.",
    "That book is no longer in the Apple Books library. Reopen this tab to refresh.",
  ],
  /* First run: nothing on this Mac can read yet. The same rows as the hub,
     in a frame, and a way into the library whatever was chosen - nobody is
     made to download any one model (owner, 15/09). */
  "setup.title": ["Chọn cách đọc để bắt đầu", "Choose how to read, to begin"],
  "setup.description": [
    "Tải mô hình về máy một lần để đọc offline, hoặc dùng giọng API bằng khoá của bạn. Đổi bất cứ lúc nào trong Giọng đọc & mô hình.",
    "Download a model once to read offline, or use API voices on your own key. Change it any time under Voices & models.",
  ],
  "setup.enter": ["Vào thư viện", "Go to the library"],
  /* The hub on the home screen: what this Mac reads, by language, and how
     to add to it (owner, 15/09: "một nơi thống kê để user quản lý và tải
     model hoặc nhập API"). */
  "hub.title": ["Giọng đọc & mô hình", "Voices & models"],
  "hub.caption": [
    "Máy này đọc được gì, bằng giọng nào. Tải mô hình hoặc nhập khoá API ở đây.",
    "What this Mac reads, and with which voices. Download a model or add an API key here.",
  ],
  ...
  "hub.api_note": [
    "Giọng API đọc được cả hai thứ tiếng, tính phí theo khoá của bạn.",
    "API voices read both languages, billed to your own key.",
  ],
  ...
  "settings.no_voice": ["Chưa có giọng {language} trên máy này.", "No {language} voice on this Mac yet."],
  "settings.no_voice_hint": [
    "Tải mô hình về máy, hoặc nhập khoá API trong Giọng đọc & mô hình.",
  ...
  "settings.chime_hint": ["Chương âm dài, mục âm ngắn", "Long at chapters, short at sections"],
  ...
  /* The nudge: the text is in a language the voice in use was not made
     ...
     nên dùng model nào"). */
  "hint.mismatch": [
    "Nội dung này là {language}, còn giọng đang chọn được làm cho thứ tiếng kia.",
    "This text is {language}; the voice in use was made for the other language.",
  ],
  "hint.no_voice": [
    "Nội dung này là {language}, nhưng chưa có giọng nào cho thứ tiếng đó.",
    "This text is {language}, but there is no voice for it yet.",
  ],
  "hint.switch": ["Đọc bằng {language}", "Read in {language}"],
  "hint.get": ["Thêm giọng {language}", "Add a {language} voice"],
  ...
  /* The menu bar (HIG 4.1): every command's home, in the app's language. */
  "menu.about": ["Giới thiệu ReadEase", "About ReadEase"],
  "menu.services": ["Dịch vụ", "Services"],
  "menu.hide": ["Ẩn ReadEase", "Hide ReadEase"],
  "menu.hide_others": ["Ẩn ứng dụng khác", "Hide Others"],
  "menu.show_all": ["Hiện tất cả", "Show All"],
  "menu.quit": ["Thoát ReadEase", "Quit ReadEase"],
  "menu.file": ["Tệp", "File"],
  "menu.add_to_library": ["Thêm vào thư viện…", "Add to Library…"],
  "menu.apple_books": ["Từ Apple Books…", "From Apple Books…"],
  "menu.close_document": ["Đóng tài liệu", "Close Document"],
  "menu.edit": ["Chỉnh sửa", "Edit"],
  "menu.undo": ["Hoàn tác", "Undo"],
  "menu.redo": ["Làm lại", "Redo"],
  "menu.cut": ["Cắt", "Cut"],
  "menu.copy": ["Chép", "Copy"],
  "menu.paste": ["Dán", "Paste"],
  "menu.select_all": ["Chọn tất cả", "Select All"],
  "menu.find": ["Tìm trong tài liệu", "Find in Document"],
  "menu.view": ["Xem", "View"],
  "menu.sidebar_show": ["Mở cột bên", "Show Side Column"],
  "menu.sidebar_hide": ["Thu cột bên", "Hide Side Column"],
  "menu.text_larger": ["Cỡ chữ lớn hơn", "Make Text Bigger"],
  "menu.text_smaller": ["Cỡ chữ nhỏ hơn", "Make Text Smaller"],
  "menu.text_default": ["Cỡ chữ mặc định", "Default Text Size"],
  "menu.appearance": ["Giao diện", "Appearance"],
  "menu.fullscreen": ["Toàn màn hình", "Enter Full Screen"],
  "menu.reading": ["Đọc", "Reading"],
  "menu.play": ["Đọc tiếp", "Resume Reading"],
  "menu.pause": ["Tạm dừng", "Pause Reading"],
  "menu.stop": ["Dừng đọc", "Stop Reading"],
  "menu.read_selection": ["Đọc phần đã chọn", "Read Selection"],
  "menu.voice_settings": ["Cài đặt giọng đọc…", "Voice Settings…"],
  "menu.hub": ["Giọng đọc & mô hình…", "Voices & Models…"],
  "menu.window": ["Cửa sổ", "Window"],
  "menu.minimize": ["Thu nhỏ", "Minimize"],
  "menu.zoom": ["Phóng to", "Zoom"],
  "menu.bring_all_to_front": ["Đưa tất cả ra trước", "Bring All to Front"],
  "menu.help": ["Trợ giúp", "Help"],
  ...
  "update.on_quit_armed": ["Sẽ cài ReadEase {version} khi bạn thoát app.", "ReadEase {version} will be installed when you quit."],
  "update.install_now": ["Cài và khởi động lại", "Install and Relaunch"],
  "update.skip": ["Bỏ qua phiên bản này", "Skip This Version"],
  "update.auto": ["Tự động tải và cài bản mới", "Automatically download and install updates"],
  "update.latest_unknown": ["Chưa kiểm tra.", "Not checked yet."],
  "menu.update_available": ["Đã có ReadEase {version} · Cập nhật…", "ReadEase {version} Is Available · Update…"],
  "menu.update_ready": ["ReadEase {version} đã sẵn sàng · Cài đặt…", "ReadEase {version} Is Ready · Install…"],
...
const RUNTIME_EN: Record<string, string> = {
  ...
  "Mở tài liệu hoặc dán nội dung để bắt đầu.": "Open a document or paste text to begin.",
  "Không thể mở tài liệu.": "Could not open the document.",
  "Tài liệu đã được thêm nhưng chưa thể tải lại. Hãy mở lại ứng dụng.": "The document was added but could not be reloaded. Reopen the app.",
  "Đã thêm tài liệu nhưng chưa thể tải lại.": "Document added but not reloaded.",
  ...
  "Tài liệu đã có trong thư viện; đã mở lại.": "This document is already in the library and has been reopened.",
  "Đã thêm tài liệu vào thư viện.": "Document added to the library.",
  "Không thể tải tài liệu từ thư viện cục bộ. Hãy mở lại ứng dụng.": "Could not load the document from the local library. Reopen the app.",
  "Không tìm thấy tài liệu trong thư viện.": "The document was not found in the library.",
  "Tài liệu không có đoạn văn có thể đọc.": "This document has no readable paragraphs.",
  "Sẵn sàng đọc.": "Ready to read.",
  "Không thể lưu vị trí đọc. Tài liệu vẫn có thể mở lại.": "Could not save the reading position. The document can still be reopened.",
  "Không thể lưu vị trí đọc.": "Could not save the reading position.",
  "Không thể lưu tùy chọn đọc. Tài liệu vẫn có thể mở lại.": "Could not save reading preferences. The document can still be reopened.",
  "Không thể lưu tùy chọn đọc.": "Could not save reading preferences.",
  "Hãy mở một tài liệu trước khi bấm đọc.": "Open a document before pressing Read.",
  ...
  "Không tìm thấy tệp đã chọn.": "The selected file was not found.",
  "Không thể kiểm tra tệp đã chọn.": "Could not inspect the selected file.",
  "Tệp vượt giới hạn dung lượng 200 MiB.": "The file exceeds the 200 MiB size limit.",
  "Không thể chuẩn bị thư viện để sao chép tài liệu.": "Could not prepare the library to copy the document.",
  "Không thể cập nhật thư viện cục bộ; tài liệu chưa được thêm.": "Could not update the local library; the document was not added.",
  "Không thể sao chép tài liệu vào thư viện cục bộ.": "Could not copy the document into the local library.",
  ...
  "Nội dung hình ảnh EPUB không còn khớp với bản đã nhập.": "The EPUB image content no longer matches the imported copy.",
  ...
  "Spine EPUB không còn khớp bản đã nhập.": "The EPUB spine no longer matches the imported copy.",
  "Nguồn EPUB được quản lý đã thay đổi.": "The managed EPUB source has changed.",
  "Nguồn EPUB không khớp bản đã nhập.": "The EPUB source does not match the imported copy.",
  ...
  "Không thể khóa thư viện cục bộ để nhập tài liệu.": "Could not lock the local library for import.",
  ...
  "Dữ liệu tài liệu trong thư viện cục bộ bị hỏng.": "The document data in the local library is damaged.",
  "Không thể lưu tài liệu đang mở.": "Could not save which document is open.",
  "Dữ liệu tài liệu đang mở trong thư viện cục bộ bị hỏng.": "The record of the open document in the local library is damaged.",
