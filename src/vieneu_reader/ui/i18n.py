...
_TEXT: dict[str, tuple[str, str]] = {
    ...
    "external.steps_accessible": (
        "Hướng dẫn quét đọc phần đã chọn",
        "How to read the text you have selected",
    ),
    ...
    "external.shortcut_change_accessible": (
        "Đổi phím tắt quét đọc phần đã chọn",
        "Change the shortcut that reads the selection",
    ),
    ...
    "external.history_accessible": (
        ...
        "Text read from a selection this session",
    ),
    "external.replay": ("Nghe lại phần đã chọn", "Replay selected item"),
    "external.replay_accessible": (
        "Nghe lại phần đang chọn trong lịch sử phiên",
        "Replay the selected item from session history",
    ),
    "external.starting": ("Đang chuẩn bị phím tắt…", "Preparing the shortcut…"),
    "external.ready": ("Sẵn sàng quét đọc", "Ready to read a selection"),
    ...
    "player.source.apple_books": ("Quét đọc", "Read a selection"),
